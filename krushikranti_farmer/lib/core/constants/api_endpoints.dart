...
class ApiEndpoints {
  ...
  static String get forgotPasswordVerifyToken =>
      "$baseUrl/auth/forgot-password/verify-token";
  ...
  static String farmById(String farmId) =>
      "$baseUrl/farmer/profile/farms/$farmId";
  static String get farmsCount => "$baseUrl/farmer/profile/farms/count";
  static String get farmsCollateral =>
      "$baseUrl/farmer/profile/farms/collateral";
  ...
  static String cropById(String cropId) =>
      "$baseUrl/farmer/profile/crops/$cropId";
  static String cropsByFarm(String farmId) =>
      "$baseUrl/farmer/profile/crops/farm/$farmId";
  ...
  static String get subscriptionProfileCheck =>
      "$baseUrl/subscription/profile-check";
  static String get subscriptionPaymentInitiate =>
      "$baseUrl/subscription/payment/initiate";
  static String get subscriptionPaymentComplete =>
      "$baseUrl/subscription/payment/complete";

  // Weather Endpoints
  static String weatherFarmCurrent(String farmId) =>
      "$baseUrl/farmer/weather/farm/$farmId/current";
  static String weatherFarmForecast(String farmId, int days) =>
      "$baseUrl/farmer/weather/farm/$farmId/forecast?days=$days";
  static String get weatherPrimaryCurrent =>
      "$baseUrl/farmer/weather/primary/current";
  static String weatherPrimaryForecast(int days) =>
      "$baseUrl/farmer/weather/primary/forecast?days=$days";
